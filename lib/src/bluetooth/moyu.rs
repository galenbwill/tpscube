use crate::bluetooth::uuid_from_u32;
...
impl<P: Peripheral + 'static> MoYuCube<P> {
    ...
    pub async fn new(
        ...
        let last_qgyro_actual: Vec<Option<QGyroState>> = [None].to_vec();
        let last_qgyro = &last_qgyro_actual.clone();
            ...
            .for_each(|value| async move {
                if value.uuid == gyro_uuid {
                    ...
                    if let Some(gyro) = last_qgyro[0] {
                        ...
                        if changed {
                            let mut lg = last_qgyro.clone();
                            lg[0] = Some(qgyro_state);
                            if DEBUG_GYRO {
...
impl<P: Peripheral> BluetoothCubeDevice for MoYuCube<P> {
    ...
    fn reset_cube_state(&self) {
        ...
        //         let messages = [
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x00,
        //                 0x10, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x01,
        //                 0x10, 0x25, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x02,
        //                 0x10, 0x42, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x03,
        //                 0x10, 0x6B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x04,
        //                 0x10, 0x83, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x05,
        //                 0x10, 0xA7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x06,
        //                 0x10, 0xCA, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x07,
        //                 0x10, 0xF4, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x08,
        //                 0x10, 0x14, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x09,
        //                 0x10, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0A,
        //                 0x20, 0x5A, 0x00, 0x00, 0x00, 0x00, 0x10, 0x11, 0x11, 0x11, 0x11, 0x22,
        //                 0x22, 0x22, 0x22, 0x32, 0x33, 0x33, 0x33,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0A,
        //                 0x21, 0x33, 0x44, 0x44, 0x44, 0x44, 0x54, 0x55, 0x55, 0x55, 0x55, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0B,
        //                 0x10, 0x6A, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0C,
        //                 0x10, 0x96, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0D,
        //                 0x10, 0xB4, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0E,
        //                 0x50, 0xD8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x80, 0x3F, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0E,
        //                 0x51, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0E,
        //                 0x52, 0x00, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00,
        //                 0x80, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0E,
        //                 0x53, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x3F,
        //                 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0E,
        //                 0x54, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x0F,
        //                 0x10, 0xF4, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x10,
        //                 0x50, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        //                 0x00, 0x00, 0x00, 0x00, 0x80, 0x3F, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x10,
        //                 0x51, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x5C, 0x92, 0x61, 0xBD,
        //                 0x69, 0x00, 0xE6, 0xBB, 0x1A, 0xE8, 0x39,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x10,
        //                 0x52, 0xBC, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00, 0x80, 0x3F, 0x00, 0x00,
        //                 0x80, 0x3F, 0x00, 0x00, 0x00, 0x00, 0x00,
        //             ],
        //             [
        //                 0x4B, 0x00, 0x1B, 0x00, 0x17, 0x00, 0x04, 0x00, 0x52, 0x1D, 0x00, 0x10,
